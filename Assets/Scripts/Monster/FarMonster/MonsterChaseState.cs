...
public class MonsterChaseState : MonsterState2
{
    private MonsterFar monster;
    public MonsterChaseState(MonsterStateMachine2 _stateMachine, GameObject _player, MonsterFar _monster) : base(_stateMachine, _player)
    {
        monster = _monster;
    }
